	...
	posts = append([]Post{
		{
			...
			Date:    "August 13, 2026",
			Tag:     "Platforms",
			Summary: "Gemini crossed one billion monthly active users, and Google's usage breakdown suggests the bigger shift is not the number itself but how people interact with the assistant: mostly by voice, often with a camera or screen pointed at the world.",
			Sections: []Section{
				{Paragraphs: []string{
				...
				{Heading: "What's next", Paragraphs: []string{
					...
					"Related reading: Google's July 23 piece on the delayed Gemini 3.5 Pro rollout (\"Google Just Shipped Three New Gemini Models\") and the May 21 coverage of Gemini's early agentic push at Google I/O 2026 both trace the product decisions that fed into this growth curve.",
				}},
				{Heading: "Sources", Paragraphs: []string{
					...
					"https://siliconangle.com/2026/08/11/googles-gemini-ai-app-passes-1-billion-monthly-active-users/",
					"https://techcrunch.com/2025/05/20/googles-gemini-ai-app-has-400m-monthly-active-users/",
				}},
			},
			Related: []Link{
				{Title: "Google Just Shipped Three New Gemini Models. The One Everyone Actually Wants Still Isn't Ready.", Slug: "gemini-3-5-pro-third-delay-flash-stopgap-2026"},
				{Title: "Google I/O 2026's Gemini Agentic Push Signals a Shift in Enterprise AI", Slug: "post-google-io-2026-geminis-new-agentic-capabilities-signal-a-shift-in-enterprise-ai"},
				{Title: "Google Search's Agent Workbench Puts Gemini Inside the Query", Slug: "google-search-agent-workbench-gemini-2026"},
			},
		},
	}, posts...)
}
